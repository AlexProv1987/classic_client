...
export function ArticleList({
    ...
    const handleKBStatusSync = (status: boolean) => {
        //if a kb is updated to active or inactive and its the currently viewed knowledge base articles sync the active state
    }
                ...
                <Card className="shadow" style={{ minHeight: '85vh' }}>
                    ...
                    <Card.Body className="content">
                        <NoUserSelected
                            ...
                            optional_msg="Click an eye to view article list"
                            icon={FileText}
                            icon_size={80}
                        />
                    </Card.Body>
